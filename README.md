...
- Da adesso, se nel server non ci sono giocatori, il tempo del mondo si fermerà.
- Introdotti i simboli atmosferici nella scoreboard in base al tempo atmosferico del gioco.
...
- Modificate le variabili dell'identità di genere: adesso si baseranno su "Maschio" e "Femmina".
- Modificato il nome dei "punti": adesso è "fama".
- Rivisitata la GUI delle Impostazioni dei giocatori e introdotte tre tipologie di impostazioni: Personalizzazione, Notifiche e Privacy.
- Introdotto il messaggio di bentornato all'ingresso nel server.
- Introdotto il tasto "Wiki dell'SMP" nella GUI del Profilo SMP.
